              ...
              <div class="tab-content" id="v-pills-tabContent">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      Global state created with Redux to handle app states such
                      as profile and dashboard features. Three reducer files
                      with 20+ states, three action files with 40+ methods,
                ...
                >
                  ...
                  <ul>
                    <li>
                      From scratch, I designed and implemented a Firebase
                      database structure for an AI software, including three
                      models with over 10 sub-collections each. Additionally, I
                      created two RDBMS models for real-time data syncing, and
                      incorporated Firebase's authentication service. I
                      determined the database structure based on business
                      requirements.
                    </li>
                    <li>
                      Used ContextAPI to create four state provider wrappers for
                      different features. Each wrapper had over 10 methods. Used
                      ContextAPI with React useReducer to power the small web
                      app to the maximum
                    </li>
                  </ul>
                </div>
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      Developed four SEO-friendly websites for different
                      companies across various sectors, using WordPress with
                      Elementor. Adhering to all SEO guidelines, I ensured the
                      websites featured proper content hierarchy, alt tags,
                      sitemaps, and accurately replicated their respective
                      designs
                    </li>
                  </ul>
                </div>
